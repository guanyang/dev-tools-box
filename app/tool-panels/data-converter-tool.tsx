...
import { convertData, formatSql, queryJsonPath, validateJsonSchema, type DataFormat, type SqlDialect, type SqlKeywordCase } from "../tool-logic/data-format";
    ...
    <section className="tool-panel">
      ...
      {mode === "convert" && <>
        <div className="action-bar">
          ...
          <button type="button" disabled={sourceFormat === targetFormat} onClick={convert}>转换</button>
